...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.snEdit.setGeometry(QRect(40, 10, 361, 20))

        self.pushButton = QPushButton(self.centralwidget)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(10, 40, 391, 24))

        

        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 70, 55, 16))
        self.pwEdit = QTextEdit(self.centralwidget)
        self.pwEdit.setObjectName(u"pwEdit")
        self.pwEdit.setGeometry(QRect(10, 90, 391, 71))
        self.pwEdit.setReadOnly(True)
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(10, 170, 411, 16))
